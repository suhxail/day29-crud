...
function Dashboard({ studentList, mentorList, deleteStudent, deleteMentor, editStudent, editMentor, mentors }) {
                ...
                </td>
                {
                  mentor ?
                    <td>
                      ...
                      <button className="btn btn-danger" onClick={() => deleteMentor(index)}>Delete</button>
                    </td>
                    : ""
                }
              </tr>
